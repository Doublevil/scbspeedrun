...
In these conditions, switching from ink cartridge to any other cartridge will launch you up in the air for seemingly no reason.
...
This technique is probably useless, for many reasons, the most important one being that it seems to only work in certain Power Plants levels, where you typically don't have the ink cartridge.
